...
<div className="d-flex justify-contain-between lead p-3 bg-light fw-bold">
  <div>
  ...
  <p>
    ...
    <button className="btn btn-outline-warning col card-button"
     style={{
     ...
     Add to Card 
       ...
       <div className="col-md-3">
         ...
         <hr />
         {related?.length < 1 && <p className="fw-bold fs-1">Nothing Found</p>}
         {related?.map((p) => (
