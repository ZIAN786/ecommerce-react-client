...
import UserCartSidebar from "../components/cards/UserCartSidebar.js";
import ProductCardHorizontal from "../components/cards/ProductCardHorizontal.js";
        ...
        <div className="row">
            <div className="col-md-12">
              <div className="p-3 mt-2 mb-2 h4 bg-light text-center">
                {cart?.length ? "My Cart" : <div className="text-center">
